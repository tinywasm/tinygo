...
|-------|-------------|-------------|
| 1 | [Core: config, options, constants](stages/stage1_core.md) | — |
| 2 | [Install: download, extract, Install()](stages/stage2_install.md) | Stage 1 |
| 3 | [Detect: IsInstalled, GetPath, GetVersion, EnsureInstalled](stages/stage3_detect.md) | Stage 2 |
